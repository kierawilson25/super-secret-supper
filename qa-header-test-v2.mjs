  ...
  try {
    ...
    if (headerCount === 0) {
      ...
      if (currentUrl.includes('/login')) {
        console.log('⚠️  WARNING: Redirected to login page - signup may have failed');
        results.bugs.push({
          severity: 'High',
          title: 'Signup flow may not be working',
          description: 'After submitting signup form, user was redirected to login page instead of profile',
